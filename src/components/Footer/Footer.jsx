        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold">National Schools team chess championship</h3>
            </div>
          ...
          <div>
            ...
            <ul className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} space-y-2`}>
              ...
              <li className="flex items-center gap-2">
                ...
                nationalschoolsteamchess@gmail.com
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-center`}>
              © {new Date().getFullYear()} Ecobank schools team chess Championship 2025. All rights reserved.
            </p>
          </div>
        </div>
      </div>
